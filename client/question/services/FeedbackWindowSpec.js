...
/**
 * @fileoverview Unit tests for FeedbackWindowService.
 */

describe('FeedbackWindowService', function() {
  var FeedbackWindowService;
  ...
  describe("isFeedbackSupported", function() {
    it('should return true if feedback is supported', function() {
      ...
      inject(function($injector) {
        FeedbackWindowService = $injector.get('FeedbackWindowService');
      });
      expect(FeedbackWindowService.isFeedbackSupported()).toEqual(true);
    });
    ...
    it('should return false if feedback is not supported', function() {
      ...
      expect(FeedbackWindowService.isFeedbackSupported()).toEqual(false);
    });
  });
});
